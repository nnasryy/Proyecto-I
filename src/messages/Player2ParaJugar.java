 ...
 * @author nasry
 */
public class Player2ParaJugar extends javax.swing.JFrame {

    /**
     * Creates new form Player2ParaJugar
     */
    public Player2ParaJugar() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 130, -1, 60));

        jLabel4.setFont(new java.awt.Font("Cold Warm", 0, 25)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(0, 255, 0));
        jLabel4.setText("error : se requieren 2 jugadores como minimo");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 120, -1, 60));
